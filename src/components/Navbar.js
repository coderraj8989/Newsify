                    ...
                    <div className="container-fluid">
                        ...
                        <div className="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                                ...
                                <li className="nav-item">
                                    <a className="nav-link" href="/about">National</a>
                                </li>
                                <li className="nav-item">
                                ...
                                <li className="nav-item">
                                    <a className="nav-link" href="/about">Startup</a>
                                </li>
                                <li className="nav-item">
                                ...
                                <li className="nav-item">
                                    <a className="nav-link" href="/about">Automobile</a>
                                </li>
                                <li className="nav-item">
                                    <a className="nav-link" href="/about">Miscellaneous</a>
                                </li>
                                <li className="nav-item">
